//
//  CharacterCoverCollectionViewCell.swift
//  RickandMorty
//
...
class CharacterCoverCollectionViewCell: UICollectionViewCell {
    
    static let identifier = "CharacterCoverCollectionViewCell"
